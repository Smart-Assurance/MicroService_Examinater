...
public class ExaminaterController {
    ...
    @PostMapping("/add")
    public ResponseEntity<MessageResponse> addExaminater(@RequestBody AddExaminaterRequest addExaminaterRequest) {
        try {
    ...
    @GetMapping("/getAll")
    public ResponseEntity<List<Examinater>> getAllExaminaters() {
        try {
    ...
    public ResponseEntity<Examinater> getExaminaterById(@PathVariable String examinaterId) {
        try {
    ...
    public ResponseEntity<MessageResponse> deleteExaminater(@PathVariable String examinaterId) {
        try {
            Optional<Examinater> examinater = examinaterRepository.findById(examinaterId);
